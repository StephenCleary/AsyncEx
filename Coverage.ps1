$testProjectLocations = @('test/AsyncEx.Tasks.UnitTests', 'test/AsyncEx.Coordination.UnitTests', 'test/AsyncEx.Context.UnitTests', 'test/AsyncEx.Oop.UnitTests', 'test/AsyncEx.Interop.Eap.UnitTests')
